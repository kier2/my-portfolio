...
<template>
  <div class="bg-white py-16">
    <div class="mx-auto max-w-7xl flex justify-center">
      <div class="mx-auto mt-10 grid max-w-lg grid-cols-6 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-8 lg:mx-0 lg:max-w-5xl lg:grid-cols-9">
        <img
